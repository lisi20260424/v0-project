...
export const MODEL_CONFIG_SCHEMA: Record<ModelType, ModelConfigField[]> = {
  video: [
    ...
    },
    {
      ...
      description: "用英文逗号分隔。主流模型支持 24-60fps，Kling 支持 24-60fps，Veo 支持 24-60fps",
      defaultValue: "24, 30, 60",
    },
    {
      key: "default_framerate",
      label: "默认帧率",
      type: "number",
      defaultValue: 30,
    },
    {
      ...
      description: "如 720p / 1080p / 4K / 8K 等。Veo 3.1 原生支持 4K",
      defaultValue: "720p, 1080p, 4K",
    },
    {
    ...
    {
      key: "supports_motion_control",
      label: "支持运动强度控制",
      type: "boolean",
      description: "Runway / Kling 支持。生成页显示运动强度滑块",
      defaultValue: false,
    },
    {
      key: "supports_guidance_scale",
      label: "支持引导强度 (Guidance Scale)",
      type: "boolean",
      description: "部分模型支持提示词遵循度调节",
      defaultValue: false,
    },
    {
      key: "guidance_scale_range",
      label: "引导强度范围",
      type: "text",
      placeholder: "0-20",
      description: "如 Stable Diffusion 为 0-20，DALL-E 为 0-10",
    },
    {
  ...
  image: [
    ...
    {
      key: "supports_cfg_scale",
      label: "支持提示词强度 (CFG)",
      type: "boolean",
      description: "Stable Diffusion 支持 CFG 0-20（推荐 7-15）",
      defaultValue: false,
    },
    {
      key: "cfg_scale_range",
      ...
      type: "text",
      placeholder: "0-20",
      description: "Stable Diffusion 推荐 7-15 为最佳",
    },
    {
      key: "supports_sampling_steps",
      label: "支持采样步数",
      type: "boolean",
      description: "Stable Diffusion 支持。步数越多细节越丰富但速度越慢",
      defaultValue: false,
    },
    {
      key: "sampling_steps_range",
      label: "采样步数范围",
      type: "text",
      placeholder: "20-150",
      description: "Stable Diffusion 推荐 20-50 为平衡点",
    },
    {
      key: "supports_seed",
      label: "支持种子值",
      type: "boolean",
      description: "Midjourney / Stable Diffusion 支持。相同种子+提示词会生成相同结果",
      defaultValue: false,
    },
    {
      key: "supports_chaos",
      label: "支持随机度 (Chaos)",
      type: "boolean",
      description: "Midjourney 的 --chaos 参数，控制结果多样性（0-100）",
      defaultValue: false,
    },
    {
      key: "max_prompt_length",
  ...
  music: [
    ...
    {
      key: "supports_duration_selection",
      label: "支持时长选择",
      type: "boolean",
      description: "用户可自由选择生成曲目时长（而非预设值）",
      defaultValue: true,
    },
    {
      key: "model_version",
      ...
      type: "select",
      options: [
        { value: "v4", label: "Suno v4（基础）" },
        { value: "v4_5", label: "Suno v4.5（标准）" },
        { value: "v5", label: "Suno v5（最新）" },
      ],
      defaultValue: "v5",
    },
    {
    ...
    },
    {
      ...
      label: "歌词最大字符",
      type: "number",
      description: "自定义歌词模式下的限制。Suno v5 支持 5000 字符",
      defaultValue: 5000,
    },
    {
      key: "supports_style_weight",
      label: "支持风格权重调节",
      type: "boolean",
      description: "Suno v5 的 styleWeight (0-1)，控制风格遵循度",
      defaultValue: true,
    },
  ],
}
